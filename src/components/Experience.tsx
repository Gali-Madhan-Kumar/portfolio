...
const experiences = [
  ...
  },
  {
    ...
    period: "2020 - 2022",
    description: "Built responsive web applications for various clients, focusing on modern design and performance optimization.",
    achievements: [
  ...
  },
  {
    ...
    company: "Startup Co.",
    period: "2018 - 2020",
    description: "Developed user interfaces for SaaS platform, collaborated with designers and backend team to deliver features.",
    achievements: [
